...
data modify block 10028 0 10028 Items[0].components."minecraft:entity_data".data.Instructions set from storage tc:tmp new_turtle.Instructions
data modify block 10028 0 10028 Items[0].components."minecraft:entity_data".data.Fuel set from storage tc:tmp new_turtle.Fuel
