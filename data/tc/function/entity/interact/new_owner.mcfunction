...
data modify entity @s ArmorItems[0].components."minecraft:custom_data".tc.Owner.Name set from entity @e[limit=1,type=minecraft:text_display,tag=tc.tmp,tag=tc.text] text
data modify entity @s ArmorItems[0].components."minecraft:custom_data".tc.Owner.UUID set from entity @p[tag=tc.player] UUID
