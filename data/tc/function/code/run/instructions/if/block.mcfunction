...
execute if score $if_success tc.tmp matches 0 run loot insert 10028 0 10028 mine ~ ~ ~ minecraft:shears[minecraft:custom_data={tc:{IfBlock:1b}},enchantments={levels:{"minecraft:silk_touch":1}}]
