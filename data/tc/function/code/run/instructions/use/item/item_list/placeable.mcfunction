...
execute if score $use_success tc.tmp matches 0 run function tc:code/run/instructions/use/item/item_list/placeable_4
execute if score $use_success tc.tmp matches 0 run function tc:code/run/instructions/use/item/item_list/placeable_5
