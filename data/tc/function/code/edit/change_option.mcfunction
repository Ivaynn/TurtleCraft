...
execute store result score $silent tc.tmp run data get storage tc:tmp Options.Silent 1
...
# Silent
execute if score $argument tc.tmp matches 9 if score $silent tc.tmp matches 1 run data modify entity @s ArmorItems[0].components."minecraft:custom_data".tc.Instructions[0].Silent set value 0b
execute if score $argument tc.tmp matches 9 if score $silent tc.tmp matches 0 run data modify entity @s ArmorItems[0].components."minecraft:custom_data".tc.Instructions[0].Silent set value 1b
...
execute if score $argument tc.tmp matches 99 run data modify entity @s ArmorItems[0].components."minecraft:custom_data".tc.Instructions set value [{AutoMine:1b, PauseOnError:1b, Locked:1b, AutoFuel:1b, SafeMine:1b, ShowText:0b, DamagePlayers:0b, ClearCounters:1b, Silent:0b}]
