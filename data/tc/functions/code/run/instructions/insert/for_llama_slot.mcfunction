...
execute if block ~ ~ ~ #minecraft:shulker_boxes run function tc:code/run/instructions/insert/shulker_box


# Insert items in slot
execute if score $different_id tc.tmp matches 1 run function tc:code/run/instructions/insert/keep_slot
execute if score $different_id tc.tmp matches 0 run function tc:code/run/instructions/insert/insert_slot
