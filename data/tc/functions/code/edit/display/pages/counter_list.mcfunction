...
# Print line
tellraw @s [{"text":" ","hoverEvent":{"action":"show_text","contents":[{"nbt":"Counters[-1].name","interpret":false,"storage":"tc:tmp","color":"gray"}]}},{"nbt":"Counters[-1].name","interpret":true,"storage":"tc:tmp","color":"gray"},{"text":":  ","color":"gray"},{"nbt":"Counters[-1].value","storage":"tc:tmp","color":"gray"}]
