...
execute if score $status tc.tmp matches 1 run tellraw @s ["       ",{"text":"|  ","color":"dark_gray"},{"text":" STOP ","color":"red","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -202"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to stop","color":"gray"}]}}," ",{"text":" PAUSE ","color":"green","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -203"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to pause","color":"gray"}]}},{"text":"  |      ","color":"dark_gray"},{"text":" ← ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -707"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn left","color":"gray"}]}},{"text":" ↓ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -702"},"hoverEvent":{"action":"show_text","contents":[{"text":"move back","color":"gray"}]}},{"text":" → ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -708"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn right","color":"gray"}]}}]
execute if score $status tc.tmp matches 2 run tellraw @s ["      ",{"text":"|  ","color":"dark_gray"},{"text":" STOP ","color":"red","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -202"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to stop","color":"gray"}]}}," ",{"text":" UNPAUSE ","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -204"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to unpause","color":"gray"}]}},{"text":"  |    ","color":"dark_gray"},{"text":" ← ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -707"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn left","color":"gray"}]}},{"text":" ↓ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -702"},"hoverEvent":{"action":"show_text","contents":[{"text":"move back","color":"gray"}]}},{"text":" → ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger tc.trigger set -708"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn right","color":"gray"}]}}]
