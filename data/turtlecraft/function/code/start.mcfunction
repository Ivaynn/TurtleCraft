...
execute store result score $lines turtlecraft.tmp run data get entity @s equipment.feet.components."minecraft:custom_data".turtlecraft.Instructions
...
# Clear counters
execute store result score $clear_counters turtlecraft.tmp run data get entity @s equipment.feet.components."minecraft:custom_data".turtlecraft.Instructions[0].ClearCounters 1
execute if score $clear_counters turtlecraft.tmp matches 1 run data modify entity @s equipment.head set value {id:"minecraft:stick",count:1b,components:{"minecraft:custom_data":{turtlecraft:{Counters:[]}}}}
