...
execute if score @s TurtleCraft matches 1000..9999 run function turtlecraft:block/edit/find
execute if score @s TurtleCraft matches 10000.. run tellraw @s ["",{"text":"\n> ","bold":true,"color":"red"},{"text":"You should use positive numbers here!\n","color":"gray"}]
