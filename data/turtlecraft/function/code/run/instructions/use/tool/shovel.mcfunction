...
execute if block ~ ~ ~ #turtlecraft:use_tool/make_path unless score $silent turtlecraft.tmp matches 1 run playsound minecraft:item.shovel.flatten neutral @a ~ ~ ~ 1 1
execute if block ~ ~ ~ #turtlecraft:use_tool/make_path run setblock ~ ~ ~ minecraft:dirt_path

execute if block ~ ~ ~ minecraft:campfire[lit=true] unless score $silent turtlecraft.tmp matches 1 run playsound minecraft:block.fire.extinguish neutral @a ~ ~ ~ 1 1
execute if block ~ ~ ~ minecraft:soul_campfire[lit=true] unless score $silent turtlecraft.tmp matches 1 run playsound minecraft:block.fire.extinguish neutral @a ~ ~ ~ 1 1
