execute unless score $silent turtlecraft.tmp matches 1 run playsound minecraft:item.axe.scrape neutral @a ~ ~ ~ 1 1
...
execute if block ~ ~ ~ minecraft:exposed_cut_copper_stairs run function turtlecraft:code/run/instructions/use/tool/replace_copper/scrape_stairs_exposed
execute if block ~ ~ ~ minecraft:weathered_cut_copper_stairs run function turtlecraft:code/run/instructions/use/tool/replace_copper/scrape_stairs_weathered
execute if block ~ ~ ~ minecraft:oxidized_cut_copper_stairs run function turtlecraft:code/run/instructions/use/tool/replace_copper/scrape_stairs_oxidized
