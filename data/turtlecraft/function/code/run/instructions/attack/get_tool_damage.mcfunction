...
data modify storage turtlecraft:tmp tool set from entity @s equipment.mainhand
...
# Get enchantments
execute store result score $sharp_lvl turtlecraft.tmp run data get storage turtlecraft:tmp tool.components."minecraft:enchantments"."minecraft:sharpness"
execute store result score $smite_lvl turtlecraft.tmp run data get storage turtlecraft:tmp tool.components."minecraft:enchantments"."minecraft:smite"
execute store result score $bane_lvl turtlecraft.tmp run data get storage turtlecraft:tmp tool.components."minecraft:enchantments"."minecraft:bane_of_arthropods"
execute store result score $fire_lvl turtlecraft.tmp run data get storage turtlecraft:tmp tool.components."minecraft:enchantments"."minecraft:fire_aspect"
