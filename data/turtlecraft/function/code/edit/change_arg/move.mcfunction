...
execute if score $argument turtlecraft.tmp matches 1 if score limit_directions turtlecraft.options matches 1 if data storage turtlecraft:tmp {edit_arg:{direction:"forward"}} run data modify storage turtlecraft:tmp list_start[-1].A.direction set value "back"
execute if score $argument turtlecraft.tmp matches 1 if score limit_directions turtlecraft.options matches 1 if data storage turtlecraft:tmp {edit_arg:{direction:"back"}} run data modify storage turtlecraft:tmp list_start[-1].A.direction set value "up"
