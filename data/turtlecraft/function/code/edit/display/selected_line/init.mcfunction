...
# Line number json
execute unless data storage turtlecraft:tmp selected_display.bp run data modify storage turtlecraft:tmp number_json set value '[{"score":{"name":"$page_selected","objective":"turtlecraft.tmp"},"color":"green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -487"},"hoverEvent":{"action":"show_text","contents":[{"text":"Toggle breakpoint","color":"gray"}]}},{"score":{"name":"$index_selected","objective":"turtlecraft.tmp"},"color":"green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -487"},"hoverEvent":{"action":"show_text","contents":[{"text":"Toggle breakpoint","color":"gray"}]}}," "]'
execute if data storage turtlecraft:tmp selected_display.bp run data modify storage turtlecraft:tmp number_json set value '[{"score":{"name":"$page_selected","objective":"turtlecraft.tmp"},"color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -487"},"hoverEvent":{"action":"show_text","contents":[{"text":"Toggle breakpoint","color":"gray"}]}},{"score":{"name":"$index_selected","objective":"turtlecraft.tmp"},"color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -487"},"hoverEvent":{"action":"show_text","contents":[{"text":"Toggle breakpoint","color":"gray"}]}}," "]'
