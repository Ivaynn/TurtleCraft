...
execute if score $clear_counters turtlecraft.tmp matches 0 run tellraw @s ["",{"text":" Clear Counters ","color":"gray","hoverEvent":{"action":"show_text","contents":[{"text":"Counters are cleared on ","color":"gray"},{"text":"START","color":"dark_green"}]},"clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -608"}}]
execute if score $clear_counters turtlecraft.tmp matches 1 run tellraw @s ["",{"text":" Clear Counters ","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"Counters are cleared on ","color":"gray"},{"text":"START","color":"dark_green"}]},"clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -608"}}]

execute if score $silent turtlecraft.tmp matches 0 run tellraw @s ["",{"text":" Silent ","color":"gray","hoverEvent":{"action":"show_text","contents":[{"text":"Stops the turtle's sounds","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -609"}}]
execute if score $silent turtlecraft.tmp matches 1 run tellraw @s ["",{"text":" Silent ","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"Stops the turtle's sounds","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -609"}}]


# Other
tellraw @s ["\n",{"text":" RESET ","color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -699"},"hoverEvent":{"action":"show_text","contents":[{"text":"Clear instructions and reset options","color":"gray"}]}},"  ",{"text":" PICK UP ","color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -698"},"hoverEvent":{"action":"show_text","contents":[{"text":"Remove this turtle and drop all items","color":"gray"}]}},"  ",{"text":" EXIT ","color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -697"},"hoverEvent":{"action":"show_text","contents":[{"text":"Close this menu","color":"gray"}]}}]


# Tabs
tellraw @s ["\n",{"text":"HOME ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -100"},"hoverEvent":{"action":"show_text","contents":[{"text":"Home Page","color":"gray"}]}},{"text":" EDIT ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -500"},"hoverEvent":{"action":"show_text","contents":[{"text":"Edit Saved Instructions","color":"gray"}]}},{"text":" COUNTERS ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -206"},"hoverEvent":{"action":"show_text","contents":[{"text":"Show List of Counters","color":"gray"}]}},{"text":" OPTIONS ","color":"dark_aqua"},{"text":" MORE ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -208"},"hoverEvent":{"action":"show_text","contents":[{"text":"Credits and Tutorials","color":"gray"}]}}]
