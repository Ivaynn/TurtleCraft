...
tellraw @s ["\n                                     ",{"text":" ▲ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -705"},"hoverEvent":{"action":"show_text","contents":[{"text":"move up","color":"gray"}]}},{"text":" ↑ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -701"},"hoverEvent":{"action":"show_text","contents":[{"text":"move forward","color":"gray"}]}},{"text":" ▼ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -706"},"hoverEvent":{"action":"show_text","contents":[{"text":"move down","color":"gray"}]}}]


# START / STOP PAUSE / STOP UNPAUSE --- TurnLeft MoveBack TurnRight
execute if score $status turtlecraft.tmp matches 0 run tellraw @s ["            ",{"text":"  ","color":"dark_gray"},{"text":" START ","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -201"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to start","color":"gray"}]}},{"text":"             ","color":"dark_gray"},{"text":" ← ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -707"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn left","color":"gray"}]}},{"text":" ↓ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -702"},"hoverEvent":{"action":"show_text","contents":[{"text":"move back","color":"gray"}]}},{"text":" → ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -708"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn right","color":"gray"}]}}]
execute if score $status turtlecraft.tmp matches 1 run tellraw @s ["            ",{"text":"  ","color":"dark_gray"},{"text":"  ⏹  ","color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -202"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to stop","color":"gray"}]}},{"text":"  ⏸  ","color":"green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -203"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to pause","color":"gray"}]}},{"text":"            ","color":"dark_gray"},{"text":" ← ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -707"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn left","color":"gray"}]}},{"text":" ↓ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -702"},"hoverEvent":{"action":"show_text","contents":[{"text":"move back","color":"gray"}]}},{"text":" → ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -708"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn right","color":"gray"}]}}]
execute if score $status turtlecraft.tmp matches 2 run tellraw @s ["         ",{"text":"  ","color":"dark_gray"},{"text":"  ⏹  ","color":"red","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -202"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to stop","color":"gray"}]}},{"text":"  ⏵  ","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -204"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to continue","color":"gray"}]}},{"text":"  →  ","color":"green","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -209"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to run the next instruction","color":"gray"}]}},{"text":"         ","color":"dark_gray"},{"text":" ← ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -707"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn left","color":"gray"}]}},{"text":" ↓ ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -702"},"hoverEvent":{"action":"show_text","contents":[{"text":"move back","color":"gray"}]}},{"text":" → ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger TurtleCraft set -708"},"hoverEvent":{"action":"show_text","contents":[{"text":"turn right","color":"gray"}]}}]
