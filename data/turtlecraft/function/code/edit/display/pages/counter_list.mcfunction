...
# Print line
tellraw @s [{"text":" ","hoverEvent":{"action":"show_text","contents":[{"nbt":"Counters[-1].name","interpret":false,"storage":"turtlecraft:tmp","color":"gray"}]}},{"nbt":"Counters[-1].name","interpret":true,"storage":"turtlecraft:tmp","color":"gray"},{"text":":  ","color":"gray"},{"nbt":"Counters[-1].value","storage":"turtlecraft:tmp","color":"gray"}]
