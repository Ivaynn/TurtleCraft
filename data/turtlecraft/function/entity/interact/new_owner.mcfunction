...
data modify entity @s ArmorItems[0].components."minecraft:custom_data".turtlecraft.Owner.Name set from entity @e[limit=1,type=minecraft:text_display,tag=turtlecraft.tmp,tag=turtlecraft.text] text
data modify entity @s ArmorItems[0].components."minecraft:custom_data".turtlecraft.Owner.UUID set from entity @p[tag=turtlecraft.player] UUID
