...
data modify block 10028 1 10028 Items[0].components."minecraft:entity_data".data.turtlecraft.Instructions set from entity @s ArmorItems[0].components."minecraft:custom_data".turtlecraft.Instructions
