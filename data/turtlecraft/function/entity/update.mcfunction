...
execute unless score $silent turtlecraft.tmp matches 1 unless data entity @s {Fire:0s} unless data entity @s {Fire:-1s} run playsound minecraft:entity.generic.extinguish_fire neutral @a ~ ~ ~ 1 1
