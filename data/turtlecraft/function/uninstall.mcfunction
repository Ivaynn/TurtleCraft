...
tellraw @a ["",{"text":"\n> ","bold":true,"color":"dark_aqua"},{"text":"This data pack has been uninstalled. Use ","color":"gray"},{"text":"/reload","color":"dark_aqua","click_event":{action:"suggest_command",command:"/reload"}},{"text":" to reinstall. To completely remove, delete it from this world's ","color":"gray"},{"text":"datapacks","color":"dark_aqua"},{"text":" folder before using ","color":"gray"},{"text":"/reload","color":"dark_aqua","click_event":{action:"suggest_command",command:"/reload"}},{"text":" again. Turtles in loaded chunks have been removed and their items were dropped. Turtles in unloaded chunks stopped working but can't be removed.\n","color":"gray"}]
